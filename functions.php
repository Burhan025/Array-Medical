...
function parallax_enqueue_scripts_styles() {
	...
	// Scripts
	wp_enqueue_script( 'scripts', get_stylesheet_directory_uri() . '/js/scripts.js', FALSE, '1.11.0', TRUE);
