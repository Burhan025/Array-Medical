...
// Testimonials Hack on home page to reposition image

jQuery( document ).ready(function() {
	
jQuery(".home-review .ttshowcase_wrap .ttshowcase_rl_box:first-of-type .ttshowcase_rl_info_wrap .ttshowcase_rl_aditional_info").appendTo(".home-review .ttshowcase_wrap .ttshowcase_rl_box:first-of-type .tt_quote_info-left .ttshowcase_rl_quote");

jQuery(".home-review .ttshowcase_wrap .ttshowcase_rl_box:nth-child(2) .ttshowcase_rl_info_wrap .ttshowcase_rl_aditional_info").appendTo(".home-review .ttshowcase_wrap .ttshowcase_rl_box:nth-child(2) .tt_quote_info-left .ttshowcase_rl_quote");	
...
jQuery( document ).ready(function() {
	...
	jQuery(".site-header .wrap");
	
	jQuery(".nav-primary .genesis-nav-menu").before('<div style="display:none;" class="responsive-menu-icon shiftnav-toggle shiftnav-toggle-button" data-shiftnav-target="shiftnav-main" ></div>');
	
	jQuery(".shiftnav-shiftnav-main .shiftnav-nav").before('<div class="mob-header" id="text-2" style="float:none;"><a class="button cnt" href="/contact-us/">Contact Us</a></div>');
	
/*	jQuery(".shiftnav-shiftnav-main .shiftnav-nav").before('<div class="mob-header" id="text-2" style="float:none;"><a class="button chat" href="#">Live Chat</a></div>');*/
	
	jQuery(".shiftnav-shiftnav-main .shiftnav-nav").before('<div class="mob-header" id="search-4" style="float:none;"><form class="search-form" itemprop="potentialAction" itemscope="" itemtype="https://schema.org/SearchAction" method="get" action="https://arraymedical.gowiththrive.net/" role="search"><meta itemprop="target" content="https://arraymedical.gowiththrive.net/?s={s}"><input itemprop="query-input" type="search" name="s" placeholder="Search this website …"><input type="submit" value="Search"></form></div>');
	
	jQuery(".shiftnav-shiftnav-main .shiftnav-nav").before('<div class="mob-header" id="text-9" style="float:none;"><a class="call" target="_self" href="tel:4696776090" onclick=""><i class="icon-arraymedicalphone-receiver"></i>469.677.6090</a></div>');
	
	jQuery(".shiftnav-shiftnav-main .shiftnav-nav").before('<div class="mob-header" id="text-9" style="float:none;"><a class="mail" href="mailto:sales@arraymedical.com" onclick=""><i class="icon-arraymedicalmail"></i>sales@arraymedical.com</a></div>');
	
	jQuery('.widget_product_categories #product_cat option:contains("Select a category")').text('Brands');
	
	jQuery('.widget_taxonomy_dropdown_widget .taxonomy_dropdown_widget_dropdown option:contains("Select Tag")').text('Treatment type?');
